...
#
# usage : reinstall_start_observe_baseline_cpu.sh apk_path number_of_methods
# example in our case: 
# ./reinstall_start_and_observe_baseline_cpu.sh /media/lavoisier/ee9567d1-e98a-411a-8cea-516195e51630/frida_evaluation_on_many_apps/apks/locker-fe666e209e094968d3178ecf0cf817164c26d5501ed3cd9a80da786a4a3f3dc4.apk  /media/lavoisier/ee9567d1-e98a-411a-8cea-516195e51630/frida_evaluation_on_many_apps 33
# 		
#
...
if [ -z "$1" ] 
   then
	...
	RESULT_FOLDER=$2/cpu_observations/${app_file_name_without_extension}/baseline
