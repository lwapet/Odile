...
# the fourth is the number of iteration during measurements

	
#
# usage : instrument_reinstall_start_and_observe_memory_for_performance.sh apk_path number_of_methods
# example in our case: ./instrument_reinstall_start_and_observe_memory_for_performance.sh 
...
#    /media/lavoisier/ee9567d1-e98a-411a-8cea-516195e51630/frida_evaluation_on_many_apps 33
# 		
#
...
#  it will create $3/memory_observations/app_file_name_without_extenxion/memory_observations_when_testing_long_path if it not exist
...
if [ -z "$1" ] 
   then
	...
	RESULT_FOLDER=$3/memory_observations/${app_file_name_without_extension}/testing_${long_or_short}_path
	...
	(echo "toto" > $tracer_output_file_path) &
    ...
    echo "----- ----- ----- >> Third mesurements after sending js method codes, number_of_iterations =  $number_of_iterations"
	...
	do
        ...
        new_file_size=$(stat -c%s "$tracer_output_file_path"); echo "copy"; cp $tracer_output_file_path  $current_copy
